...
<h1 style="color:white;" align="center"> Gynaecologist Doctors </h1>
...
<?php
	...
	$sql = "SELECT * FROM hosp2 WHERE (location='$loc'and category='gyn')";
	...
	while($mom = $result->fetch_assoc()){
		...
		printf("<h1 align='center'> Gynaecologist Doctors Not available at %s</h1>",$loc);
	}
