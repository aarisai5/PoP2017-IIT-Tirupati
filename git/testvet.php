...
<h1 style="color:white;" align="center"> Veterinarian Doctors </h1>
...
<?php
	...
	$sql = "SELECT * FROM hosp2 WHERE (location='$loc'and category='veter')";
	...
	while($mom = $result->fetch_assoc()){
		...
		printf("<h1 align='center'> Veterinarian Doctors Not available at %s</h1>",$loc);
	}
