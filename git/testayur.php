...
<h1 style="color:white;" align="center"> Ayurvedic Doctors </h1>
...
<?php
	...
	$sql = "SELECT * FROM hosp2 WHERE (location='$loc' and category='ayur')";
	...
	while($mom = $result->fetch_assoc()){
		...
		printf("<h1 align='center'> Ayurvedic Doctors Not available at %s</h1>",$loc);
	}
