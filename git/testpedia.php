...
<h1 style="color:white;" align="center"> Pediatricians Doctors </h1>
...
<?php
	...
	$sql = "SELECT * FROM hosp2 WHERE (location='$loc'and category='pedi')";
	...
	while($mom = $result->fetch_assoc()){
		...
		printf("<h1 align='center'> Pediatricians Doctors Not available at %s</h1>",$loc);
	}
