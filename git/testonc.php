...
<h1 style="color:white;" align="center"> Oncologist Doctors </h1>
...
<?php
	...
	$sql = "SELECT * FROM hosp2 WHERE (location='$loc'and category='onco')";
	...
	while($mom = $result->fetch_assoc()){
		...
		printf("<h1 align='center'> Oncologist Doctors Not available at %s</h1>",$loc);
	}
