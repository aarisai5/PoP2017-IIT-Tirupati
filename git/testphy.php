...
<h1 style="color:white;" align="center"> Physiotherapist Doctors </h1>
...
<?php
	...
	$sql = "SELECT * FROM hosp2 WHERE (location='$loc'and category='physio')";
	...
	while($mom = $result->fetch_assoc()){
		...
		printf("<h1 align='center'> Physiotherapists Doctors Not available at %s</h1>",$loc);
	}
