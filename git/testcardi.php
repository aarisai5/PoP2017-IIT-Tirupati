...
<h1 style="color:white;" align="center"> Cardiologist Doctors </h1>
...
<?php
	...
	$sql = "SELECT * FROM hosp2 WHERE (location='$loc' and category='cardi')";
	...
	while($mom = $result->fetch_assoc()){
		...
		printf("<h1 align='center'> Cardiologist Doctors Not available at %s</h1>",$loc);
	}
