...
<h1 style="color:white;" align="center"> Urologists Doctors </h1>
...
<?php
	...
	$sql = "SELECT * FROM hosp2 WHERE (location='$loc'and category='uro')";
	...
	while($mom = $result->fetch_assoc()){
		...
		printf("<h1 align='center'> Urologists Doctors Not available at %s</h1>",$loc);
	}
