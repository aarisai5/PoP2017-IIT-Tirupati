...
<h1 style="color:white;" align="center"> Psychiatrits Doctors </h1>
...
<?php
	...
	$sql = "SELECT * FROM hosp2 WHERE (location='$loc'and category='psyc')";
	...
	while($mom = $result->fetch_assoc()){
		...
		printf("<h1 align='center'> Psychiatrits Doctors Not available at %s</h1>",$loc);
	}
