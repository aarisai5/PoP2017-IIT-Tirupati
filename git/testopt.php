...
<h1 style="color:white;" align="center"> Opthalmologists Doctors </h1>
...
<?php
	...
	$sql = "SELECT * FROM hosp2 WHERE (location='$loc'and category='optha')";
	...
	while($mom = $result->fetch_assoc()){
		...
		printf("<h1 align='center'> Opthalmologists Doctors Not available at %s</h1>",$loc);
	}
